...
const About = () => {
  return (
    <section className='xl:pt-5 lg:pt-5 md:pt-2 sm:pt-2 pt-2'>
        <div className='pt-10 w-full h-auto pb-10 block xl:flex lg:flex md:flex sm:block' data-aos="flip-left" data-aos-duration="3000">
            <div>
            ...
            <div className='xl:pt-28'>
                <h1 className='font-sans font-bold text-2xl ps-5'>ABOUT US</h1>
