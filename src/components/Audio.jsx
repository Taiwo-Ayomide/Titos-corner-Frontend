...
const Audio = () => {
  return (
    <section className='xl:pt-5 lg:pt-5 md:pt-2 sm:pt-2 pt-2'>
        <div className='pt-10 w-full bg-red-100 h-auto pb-10 block xl:flex lg:flex md:flex sm:block' data-aos="fade-out" data-aos-duration="3000">
            <div className='xl:pt-28'>
                <h1 className='font-sans font-bold text-2xl ps-5 xl:ps-24 lg:ps-24 uppercase md:ps-10 sm:ps-10'>Audio Podcast</h1>
